...
export default function Dashboard() {
  ...
  const usersTableData = useMemo(() => usuarios.slice(0, 5), [usuarios]);
  ...
  const usersColumns = useMemo(
    () => [
      ...
      },
      {
        ...
        header: "Estado",
        cell: (u: Usuario) => {
          const estadoLabel = u.estado || (u.activo ? "Activo" : "Inactivo");
          const { variant, pulse } = badgePropsForState(estadoLabel);
              ...
              <DropdownMenu.Root>
                ...
                <DropdownMenu.Portal>
                  ...
                  >
                    ...
                    {(["Administrador", "Gestor", "Tecnico"] as const).map(
                      (r) => (
                        <DropdownMenu.Item
                          key={r}
                          onSelect={(e) => {
    ...
    [saveRol, savingId, setUserEstado, usuariosLoading],
  );

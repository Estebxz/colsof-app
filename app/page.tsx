...
export default function Home() {
  return (
    <section className="w-full px-4 py-6 lg:py-0 lg:px-6">
      <div className="mx-auto w-full max-w-6xl grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
        <div>
          ...
          <p className="mb-8 font-light text-gray-700 sm:text-xl">
            ...
            la plataforma y cuenta con un sistema de notificaciones que mantiene
            informados a los usuarios sobre el estado y las actualizaciones de
            sus tickets.
          </p>
